...
$user_query = mysqli_query($con, "SELECT * FROM wall WHERE post_id='$post_id'");
...
<form action="comment_frame.php?post_id=<?php echo $post_id; ?>" id="comment_form" name="postComment<?php echo $post_id; ?>" method="POST">
	...
	<?php
$get_comments = mysqli_query($con, "SELECT * FROM comment WHERE post_id='$post_id' and (access_id = 'P' or access_id='F') and deleted='no' ORDER BY comment_date ASC");
...
if ($count != 0) {
    ...
    while ($comment = mysqli_fetch_array($get_comments)) {
        ...
        $comment_body = $comment['comment_desc'];
        $posted_by = $comment['commentor_name'];
